package com.jamierf.rcdroid.output.servo.settings;

import com.google.common.base.Objects;
import com.google.common.base.Optional;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.Maps;
import com.jamierf.rcdroid.output.servo.api.SerialMode;
...
public class Settings {
    ...
    public ChannelSettings getChannel(int port) {
        return Optional.fromNullable(channels.get(port)).or(ChannelSettings.DEFAULT_SETTINGS);
    }

    @Override
    public String toString() {
        return Objects.toStringHelper(this)
                .add("servosAvailable", servosAvailable)
                .add("servoPeriod", servoPeriod)
                .add("serialMode", serialMode)
                .add("baudRate", baudRate)
                .add("enableCrc", enableCrc)
                .add("neverSuspend", neverSuspend)
                .add("deviceNumber", deviceNumber)
                .add("miniSccOffset", miniSscOffset)
                .add("timeout", timeout)
                .add("scriptDone", scriptDone)
                .add("enablePullups", enablePullups)
